...
<template>
  ...
  >
    ...
    <AccordionItem class="AccordionItem" value='item-1'>
      ...
      <AccordionContent class="AccordionContent">
        <div class="AccordionContentText">
          Detailed description of every defect detected by CFEIntact. 
    ...
    <AccordionItem class="AccordionItem" value='item-2'>
      ...
      <AccordionContent class="AccordionContent">
        <div class="AccordionContentText">
          Data used to plot the defect landscapes on BBLabTools. 
    ...
    <AccordionItem class="AccordionItem" value='item-4'>
      ...
      <AccordionContent class="AccordionContent">
        <div class="AccordionContentText">
          Associations between sequences and their identified Open Reading Frames (ORFs). 
    ...
    <AccordionItem class="AccordionItem" value='item-5'>
      ...
      <AccordionContent class="AccordionContent">
        <div class="AccordionContentText">
          Pipeline summary data. Contains QC status for each sequence, etc. 
    ...
    <AccordionItem class="AccordionItem" value='item-6'>
      ...
      <AccordionContent class="AccordionContent">
        <div class="AccordionContentText">
          Another pipeline summary kind of file. Contains data for sequences that passed QC. This includes final verdicts and gene regions. 
          <!-- Example link to be updated -->
          <a href="#" target="_blank">Example.</a>
        </div>
      </AccordionContent>
