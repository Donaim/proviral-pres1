...
<AccordionItem class="AccordionItem" value='item-2'>
  ...
  <AccordionContent class="AccordionContent">
    <div class="AccordionContentText">
      If there are gaps (<b>X</b>'s) in the sequence, the pipeline attempts to remove them if they are clustered near the ends. If the <b>X</b>'s cannot be removed, the sequence is skipped for primer detection in that region.
    </div>
  </AccordionContent>
</AccordionItem>
