...
- It then runs a series of quality checks on the samples that it loaded.
...
- Once that's done, the proviral pipeline summarizes outputs of HIVIntact. In particular, for the generation of landscape plots.
...
What CFEIntact does is provide an automated discovery of genetic defects based on HIV sequence.
