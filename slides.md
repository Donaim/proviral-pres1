...
- As mentioned, we start with **Sample Collection**. This step was described in more detail by Aniqa. For us, it is important that it **can** fail. For example, it can result in sequences that look nothing like HIV, or even a living organism.
