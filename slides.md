...
<h1 style='color: white; opacity: 80%; text-shadow: 2px 2px 19px white;' > <b> Near-full-length HIV proviral amplification and sequencing pipeline </b> </h1>

<p style='opacity: 80%; color: white; text-shadow: 2px 2px 19px white;'><h2> by Aniqa Shahid and Vitalik Mysak</h2></p>
